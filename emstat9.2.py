...
num = ['первый', 'второй', 'третий', 'четвертый', 'пятый', 'шестой']
name = ['Коронавирус', 'Еда ВК', 'Шаги ВК', 'ТНТ', 'Спорт ВК', 'Ближний Нижний']
ids = ['7362610', '7695875', '7539087', '7857880', '7297191','7905702']
toks = []
